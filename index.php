...
<head>
    ...
    <style type="text/css">
        ...
        .wrapper{ width: 350px; padding: 20px; text-align: left; box-shadow: 0 0 20px rgba(106,155,222,0.75); border: 1px solid rgba(106,155,222,0.75); margin-top: 5em; border-radius: 5px;}
    </style>
</head>
<body>
    <center>
